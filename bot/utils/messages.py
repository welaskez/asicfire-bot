...
◾️ <b>POOLPROOF | BOT</b>
История доходности майнинг-пулов, AML-проверки добываемой криптовалюты, техподдержка 

◾️ <b>THE MINERS CLUB</b> - первая NFT коллекция от майнеров для майнеров на TON Blockchain

◾️ <b>Реальная доходность пулов</b> - ежедневная доходность популярных майнинг-пулов
◾️ <b>Журнал майнера</b> - новости индустрии майнинга
◾️ <b>AsicFire</b> - доска объявления по продаже оборудования
◾️ <b>Service</b>- гарантийный ремонт Whatsminer, Antminer, Jasminer"""
...
post_limit_message = "Сейчас вам доступно одно объявление раз в 12 часов. Пожалуйста, подождите\n\nОсталось:\n\n{time_left}."
